...
from utils.dataset_utils import get_preprocessed_dataset,get_custom_data_collator
...
def main(**kwargs):
    ...
    # {'sampler': <torch.utils.data.distributed.DistributedSampler object at 0x7f8d98079dc0>, 'batch_size': 4, 'drop_last': True, 'collate_fn': <function default_data_collator at 0x7f8da2775940>}

    print("length of dataset_train", len(dataset_train))
    custom_data_collator = get_custom_data_collator(dataset_processer,dataset_config)
    print(custom_data_collator)
